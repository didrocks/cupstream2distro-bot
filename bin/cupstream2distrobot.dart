...
void main() {
  ...
  Stream<String> backendStream = downloadservice.periodicDownload("https://docs.google.com/a/canonical.com/spreadsheet/ccc?key=0AuDk72Lpx8U5dFlCc1VzeVZzWmdBZS11WERjdVc3dmc&output=csv", 30, useDownloadScript: true);
